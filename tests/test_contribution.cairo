...
//     ContributionProcessed, ContributionStatsUpdated, Event, PlatformFeeCollected, WithdrawalMade,
// };
...
//     let calldata = array![admin.into(), 100_u128.into()]; // 1% fee
...
//     let (total_contributed, total_withdrawn) = contribution_dispatcher
//         .get_contribution_stats(1, contributor);
