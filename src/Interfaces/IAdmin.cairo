...
pub trait IAdmin<TContractState> {
    ...
    // Admin functions
    fn approve_creator_application(ref self: TContractState, creator_address: ContractAddress)-> felt252;
    fn reject_creator_application(ref self: TContractState, creator_address: ContractAddress)-> felt252;
